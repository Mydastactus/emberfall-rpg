# ⚔ The Serpent of Ironvale

*A solo RPG in the world of **Emberfall***
...
**Character portraits** — fifteen fully illustrated portraits in ornate gold-ring frames for every major face in the realm: Thorne's grandfatherly warmth, the crowned King, Sera's scar, Vail's duelist stare, Zarga's tusks and bone beads, Gar'Thok in his wolf pelt — plus a portrait for each hero class, appearing in dialogue, combat, the sidebar, and the hero sheet. Lesser faces keep the game's hand-built vector portrait style as a fallback. (Portrait illustrations are AI-generated.)
